...
<html>
    <head>
        ...
        <title>Preguntas y Respuestas. 2 Ronda</title>
    </head>
    <%
        // el modelamiento y logica de esta ronda es igual a la anterior.
        int numPregunta=PreguntaAleatoria.generarnumero(2);
        ...
        Ronda ronda = new Ronda(1, pregunta.getEnunciado(), listaRespuestas, 10);
    
    %>
    <body>
        <div class="container mt-5">
        <script>alert("respuesta correcta!!!. Puntaje obtenido: 5 puntos")</script>
        ...
        <table class="table table-striped table-hover">
            ...
            <button button type="submit" name="enviar" class="btn btn-success">Enviar Respuesta</button>
            </form>
        </div>
        <div class="container mt-5">
        ...
        <div class="container mt-5 d-grid gap-2 d-md-block">
            ...
            if (request.getParameter("enviar") != null){
                ...
                if(rtaCorrecta==1){
                    response.sendRedirect("terceraRonda.jsp");
                }else{
