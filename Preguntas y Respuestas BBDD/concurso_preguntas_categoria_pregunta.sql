...
CREATE TABLE `categoria_pregunta` (
  `idcategoria_pregunta` int NOT NULL AUTO_INCREMENT,
  `nombre` varchar(45) NOT NULL,
  PRIMARY KEY (`idcategoria_pregunta`)
...
LOCK TABLES `categoria_pregunta` WRITE;
/*!40000 ALTER TABLE `categoria_pregunta` DISABLE KEYS */;
INSERT INTO `categoria_pregunta` VALUES (1,'cultura general'),(2,'deportes'),(3,'historia'),(4,'ciencia'),(5,'literatura');
