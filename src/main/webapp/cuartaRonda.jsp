...
<html>
    <head>
        ...
        <title>Preguntas y Respuestas. 4 Ronda</title>
    </head>
    <%
        
        // el modelamiento y logica de esta ronda es igual a la anterior.
        int numPregunta=PreguntaAleatoria.generarnumero(4);
        ...
        Ronda ronda = new Ronda(1, pregunta.getEnunciado(), listaRespuestas, 30);
    
    %>
    <body>
        <div class="container mt-5">
        <script>alert("respuesta correcta!!!. Puntaje obtenido: 15 puntos")</script>
        ...
        <div class="container mt-5 d-grid gap-2 d-md-block">
            ...
            if (request.getParameter("enviar") != null){
                ...
                if(rtaCorrecta==1){
                    response.sendRedirect("quintaRonda.jsp");
                }else{
